...
{
    public function ringList(Request $request)
    {
        $param = [
    ...
    public function ringDelete(Request $request)
    {
        $param = [
    ...
    public function ringInsert(Request $request)
    {
        $param = [
    ...
    public function ringInfo(Request $request)
    {
        $param = [
    ...
    public function ringUpdate(Request $request)
    {
        $param = [
            'ringId'     => $request->param('ringId',0, 'intval'),
            'ringName'   => $request->param('ringName',''),
