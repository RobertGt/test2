jQuery(function() {
    function e(e) {
        ...
        "invalid" === e.getStatus() ? d(e.statusText) : (t.text("预览中"), n.makeThumb(e, function(e, a) {
            ...
            "progress" === n ? i.hide().width(0) : "queued" === n && (a.off("mouseenter mouseleave"), s.remove()), "error" === t || "invalid" === t ? ( d(e.statusText), w[e.id][1] = 1) : "interrupt" === t ? d("interrupt") : "queued" === t ? w[e.id][1] = 0 : "progress" === t ? (r.remove(), i.css("display", "block")) : "complete" === t && a.append('<span class="success"></span>').append('<img src="/Public/img/dels.png" class="dels">'), a.removeClass("state-" + n).addClass("state-" + t)
    ...
    function i() {
        var e, a = "";
        "ready" === k ? a = "选中" + m + "张图片，共" + WebUploader.formatSize(h) + "。" : "confirm" === k ? (e = n.getStats(), e.uploadFailNum && (a = "已成功上传" + e.successNum + "张照片，" + e.uploadFailNum + '张照片上传失败，<a class="retry" href="#">重新上传</a>失败图片')) : (e = n.getStats(), a = "共" + m + "张（" + WebUploader.formatSize(h) + "），已上传" + e.successNum + "张", e.uploadFailNum && (a += "，失败" + e.uploadFailNum + "张")), p.html(a)
        ...
        if (e !== k) {
            switch (c.removeClass("state-" + k), c.addClass("state-" + e), k = e) {
                ...
                case "confirm":
                    ...
                    break;
                case "finish":
                    a = n.getStats(), a.successNum ? (layer.msg("上传成功"),c.text("开始上传").removeClass("disabled"),o("#filePicker2").removeClass("element-invisible")) : (k = "done", location.reload())
            }
            i()
        }
    }
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        server: WEBHTTP+'Index/birthdayupload',
        fileNumLimit: 300,
    ...
    }, n.onUploadSuccess = function(e,r){
		if(r.result == 0){
			imageList[e.id] = r.data.path;
		}
	}, n.on("all", function(e) {
        switch (e) {
            case "uploadFinished":
